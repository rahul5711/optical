...
router.post('/create', verifyAccessTokenAdmin, dbConnection, Controller.create)
...
router.post('/deleteProduct', verifyAccessTokenAdmin, dbConnection, Controller.deleteProduct)
