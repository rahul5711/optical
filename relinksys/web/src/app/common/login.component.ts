...
export class LoginComponent implements OnInit {
  ...
  moduleList: any = [
    ...
    { ModuleName: 'PurchaseRegisterReport', MView: true, Edit: true, Add: true, View: true, Delete: true },
    ...
    { ModuleName: 'ExpensesRegisterReport', MView: true, Edit: true, Add: true, View: true, Delete: true },
