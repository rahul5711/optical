...
let dtm
 ...
 dtm = {
      ...
      const subs: Subscription = this.bill.saveBill(this.data).subscribe({
        next: (res: any) => {
          if (res.success) {
            ...
            // if(res.data.billByCustomer.data[0] != undefined){
            //     this.BillMaster.InvoiceNo = res.data.billByCustomer.data[0].InvoiceNo
            //    this.RewardType()
            // }
  ...
  openModal1(content1: TemplateRef<any>) {
    ...
    // this.RewardType()
    this.Insurance.BillMasterID = this.BillMaster.ID
  }
      ...
      const subs: Subscription = this.pay.customerPayment(data).subscribe({
        next: (res: any) => {
          ...
          if (rewardData.success == true) {
            ...
            if (this.company.ID == 84 || this.company.ID == 430 && this.loginShop.ID != 542 && this.loginShop.ID != 552) {
              this.sp.hide()
