...
export class BillService {
  ...
  private gstCustomerListSubject = new BehaviorSubject<any[]>([]);
  gstCustomerList$ = this.gstCustomerListSubject.asObservable();
  ...
  ReportSupportDataList() {
    return this.httpClient
      .post(`${this.url}/getReportPageSupportData`, {}, {})
      .subscribe({
        next: (resp: any) => {
          if (resp.success) {
  ...
  orderformsubmitRx(Body: any): Observable<any> {
  ...
  orderformrequestfilter(Params: any): Observable<any> {
    return this.httpClient.post<any>(this.url + '/orderformrequestfilter', { Params: Params }, httpOptions)
      .pipe(catchError(this.handleError));
  }
  ...
  updateProductStatusAll(Ids: any): Observable<any> {
    return this.httpClient.post<any>(this.url + '/updateProductStatusAll', { Ids: Ids }, httpOptions)
      .pipe(catchError(this.handleError));
  }

  convertOrderIntoInvoiceNo(OrderList: any): Observable<any> {
    return this.httpClient.post<any>(this.url + '/convertOrderIntoInvoiceNo', { OrderList: OrderList }, httpOptions)
      .pipe(catchError(this.handleError));
  }
