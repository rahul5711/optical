...
// }
  ...
  addItem() {
    ...
    this.item.ProductNameArray.push(obj);
      this.item.ProductNameArray = JSON.stringify(this.item.ProductNameArray);
          ...
          this.itemList.forEach((ele: any) => {
            if (ele.ID === null) {
              if (ele.ProductName === this.item.ProductName && Number(ele.RetailPrice) === Number(this.item.RetailPrice) && ele.UnitPrice === this.item.UnitPrice) {
                ...
                ele.PriceCut = Number(ele.PriceCut) + Number(this.item.PriceCut);
                AddQty = 1;
              }
            }
          })
...
// }
  ...
  //   this.ecommerceItem.ProductNameArray = [];
  //   let obj: any = {};
  ...
  //   // 👉 final push
  //   this.ecommerceItem.ProductNameArray.push(obj);
  ...
  //         position: 'center',
  //         icon: 'success',
  //         title: 'Product has been successfully saved from the e-commerce website.',
  //         showConfirmButton: false,
  //         timer: 1500
          
  //       })
  //         this.ecommerceItem = {
  //           ID: null, CompanyID: null, Quantity: 1, Status: 1,
