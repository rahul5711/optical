...
export class ShopListComponent implements OnInit {
  ...
  openModalEdit(content: any, datas: any) {
    ...
    if (datas !== null && datas !== undefined && datas.length !== 0) {
      ...
      this.data.Optometrist = stringToBoolean(datas.Optometrist.toString());
