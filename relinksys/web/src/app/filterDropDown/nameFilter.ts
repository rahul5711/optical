...
@Pipe({
    name: 'prodnamefilterbluk',
    pure: false
})
export class ProductNameFilterBluk implements PipeTransform {
    transform(items: any[], filter: any): any {
        if (!items || !filter) {
            return items;
        }
...
@Pipe({
    name: 'proditemfilterbluk',
    pure: false
})
export class ProductItemFilterBluk implements PipeTransform {
    transform(items: any[], filter: any): any {
        if (!items || !filter) {
            return items;
        }
...
export class CompanyName implements PipeTransform {
    transform(items: any[], filter: any): any {
        if (!items || !filter) {
            return items;
        }
