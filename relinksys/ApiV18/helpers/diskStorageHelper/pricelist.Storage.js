...
const store = multer.diskStorage({
    destination: function (req, file, cb) {
        ...
        if (!fs.existsSync('./uploads/' + year + '/' + month + '/' + CompanyID + '/' + 'pricelist')) {
            fs.mkdirSync('./uploads/' + year + '/' + month + '/' + CompanyID + '/' + 'pricelist')
        }
        cb(null, './uploads/' + year + '/' + month + '/' + CompanyID + '/' + 'pricelist')
    },
