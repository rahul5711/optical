...
const store = multer.diskStorage({
    destination: function (req, file, cb) {
        ...
        if (!fs.existsSync('./uploads/' + year + '/' + month + '/' + CompanyID  + '/'  + 'customerPower')) {
            fs.mkdirSync('./uploads/' + year + '/' + month  + '/' + CompanyID  + '/' + 'customerPower')
        }
        cb(null, './uploads/' + year + '/' + month + '/' + CompanyID + '/' + 'customerPower')
    },
