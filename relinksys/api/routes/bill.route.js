...
router.post('/orderformsubmitRxDocNo', verifyAccessTokenAdmin, dbConnection, Controller.orderformsubmitRxDocNo)
...
router.post('/send-otp-for-discount', Controller.sendWhatsAppTemplateNew)
