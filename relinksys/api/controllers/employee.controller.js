...
module.exports = {
    save: async (req, res, next) => {
        ...
        try {
            ...
            const [saveUser] = await DB.query(`insert into user(CompanyID, ShopID,Name,UserGroup,DOB,Anniversary,MobileNo1,MobileNo2,PhoneNo,Email,Address,Branch,PhotoURL,Document,LoginName,Password,Status,CreatedBy,UpdatedBy,CreatedOn,UpdatedOn,CommissionType,CommissionMode,CommissionValue,CommissionValueNB,DiscountPermission,SalePermission, IsGetReport, ExcelPermission) values(${CompanyID},${shopid},'${Body.Name}','${Body.UserGroup ? Body.UserGroup : 'Employee'}','${Body.DOB}','${Body.Anniversary}','${Body.MobileNo1}','${Body.MobileNo2}','${Body.PhoneNo}','${Body.Email}','${Body.Address}','${Body.Branch}','${Body.PhotoURL}','${Body.Document ? JSON.stringify(Body.Document) : '[]'}','${Body.LoginName}','${pass}',1,${LoggedOnUser},${LoggedOnUser},now(),now(),${Body.CommissionType},${Body.CommissionMode},${Body.CommissionValue},${Body.CommissionValueNB},'${Body.DiscountPermission}','${Body.SalePermission}','${Body.IsGetReport ? Body.IsGetReport : 'false'}', '${Body.ExcelPermission ? Body.ExcelPermission : 'false'}')`)
