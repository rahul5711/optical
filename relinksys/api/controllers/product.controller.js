...
module.exports = {
    ...
    getSpec: async (req, res, next) => {
        ...
        try {
            ...
            const query = `select ID, Name, ProductName, Ref, Required, Ecom, Seq, SptTableName, Status, Type from productspec where ProductName = '${Body.ProductName}' and Status = 1 and CompanyID = ${CompanyID} order by CAST(Seq AS SIGNED) ASC`
            const [saveData] = await connection.query(query)
