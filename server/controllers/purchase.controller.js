...
module.exports = {
    ...
    deleteCharge: async (req, res, next) => {
        try {
            ...
            const [doesExist] = await mysql2.pool.query(`select ID, SystemID, PurchaseID, TotalAmount from purchasecharge where Status = 1 and CompanyID = '${CompanyID}' and ID = '${Body.ID}'`)
