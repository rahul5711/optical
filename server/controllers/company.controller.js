    ...
    saveBillFormate: async (req, res, next) => {
        try {
            ...
            if (fetch.length) {
                ...
                // save
                const [save] = await mysql2.pool.query(`insert into billformate(CompanyID, BillHeader, HeaderWidth, HeaderHeight, HeaderPadding, HeaderMargin, ImageWidth, ImageHeight,ImageAlign, ShopNameFont, ShopNameBold, Color, ShopDetailFont, LineSpace, TableHeading, TableBody, Status, CreatedOn, CreatedBy)values(${Body.CompanyID}, '${Body.BillHeader}', '${Body.HeaderWidth}', '${Body.HeaderHeight}', '${Body.HeaderPadding}', '${Body.HeaderMargin}', '${Body.ImageWidth}', '${Body.ImageAlign}', '${Body.ImageHeight}', '${Body.ShopNameFont}', '${Body.ShopNameBold}', '${Body.Color}', '${Body.ShopDetailFont}', '${Body.LineSpace}', '${Body.CustomerFont}', '${Body.CustomerLineSpace}', '${Body.TableHeading}','${Body.TableBody}', '${Body.NoteFont}','${Body.NoteLineSpace}', 1,now(),0)`)
            }
